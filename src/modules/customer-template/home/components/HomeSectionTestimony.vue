...
const testimonials: Testimony[] = [
  {
    quote: '"Thanks to the great services and tools plus ongoing guidance, our profit improved by 35% in just one season — with less personnel and simple processes."',
    name: 'Daniel Kwame',
